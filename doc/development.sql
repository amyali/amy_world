...
It is not silly to enrich the dry arithmetic of GDP with a concern for the satisfaction of human lives. The World Bank has successfully pioneered the human development index, which ranks nations according to their social as well as economic achievements. Freedom, in other words, is an important part of development.
